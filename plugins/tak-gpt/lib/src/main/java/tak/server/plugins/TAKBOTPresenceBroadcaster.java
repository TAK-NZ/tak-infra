...
public class TAKBOTPresenceBroadcaster {
	...
	private String groupName = "Purple";
	private String role = "HQ";
	private String cotType = "a-f-G-U-C-I";
	private final Set<String> groups = new HashSet<>();
	
	public static void main(String[] args) throws DocumentException {
		List<String> groups = new ArrayList<>();
		TAKBOTPresenceBroadcaster b = new TAKBOTPresenceBroadcaster("takGPT", 0.0, 0.0, groups, "Purple", "HQ", "a-f-G-U-C-I");
	 ...
	 * @param groupName The display group name (e.g., "Purple", "Cyan").
	 * @param role The role (e.g., "HQ", "Team Member").
	 * @param cotType The CoT type (e.g., "a-f-G-U-C-I").
	 */
	public TAKBOTPresenceBroadcaster(String botName, Double latitude, Double longitude, List<String> groups, String groupName, String role, String cotType) {
		...
		LOGGER.info("BOT [" + botName + "] configured to use groups: " + this.groups + ", groupName: " + this.groupName + ", role: " + this.role + ", cotType: " + this.cotType);
	}
